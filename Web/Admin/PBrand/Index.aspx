<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Maticsoft.Web.Admin.PBrand.Index" %>
                ...
                <tr>
                    <td height="25" align="left">
                        ...
                        <asp:DropDownList ID="DropField" runat="server" Width="150px">
                            <asp:ListItem Value="SupplierName">广告商名</asp:ListItem>
                            <asp:ListItem Value="ContactMan">联系人</asp:ListItem>
                            <asp:ListItem Value="Phone">电话</asp:ListItem>
                            <asp:ListItem Value="Area">地区</asp:ListItem>
                        </asp:DropDownList>
                ...
                <tr>
                    <td bgcolor='<%=Application[Session["Style"].ToString()+"xtable_bgcolor"]%>'>
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            OnRowDataBound="gridView_RowDataBound" CellPadding="5" BorderWidth="1px" PageSize="5" OnRowDeleting="gridView_RowDeleting" OnSorting="gridView_Sorting"
                            DataKeyNames="BrandId">
                            <Columns>                               
                                <asp:BoundField DataField="BrandId" HeaderText="编号" SortExpression="BrandId" />
                                <asp:BoundField DataField="Name" HeaderText="名称" />
                                <asp:BoundField DataField="Descn" HeaderText="描述" />
                                <asp:BoundField DataField="CategoryId" HeaderText="父类别"  />                                
                                <asp:HyperLinkField HeaderText="详细" DataNavigateUrlFields="BrandId" DataNavigateUrlFormatString="show.aspx?id={0}"
                                    Text="详细" />
                                <asp:HyperLinkField HeaderText="修改" DataNavigateUrlFields="BrandId" DataNavigateUrlFormatString="modify.aspx?id={0}"
                                    Text="修改"  />
