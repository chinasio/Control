<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Maticsoft.Web.Admin.Product.Index" %>
                        ...
                        <asp:GridView ID="gridView" runat="server" AutoGenerateColumns="False" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="ProductId" HeaderText="编号" SortExpression="ProductId" />
                                 <asp:HyperLinkField HeaderText="商品" DataNavigateUrlFields="ProductId" DataNavigateUrlFormatString="../../ProductDetails.aspx?ProductId={0}"
                                    Text="商品名" DataTextField="Name" />
                                
                                <asp:BoundField DataField="CategoryId" HeaderText="类别"  />
                                <asp:BoundField DataField="Price" HeaderText="参考价格" />
                                <asp:BoundField DataField="VipPrice" HeaderText="会员价格"  Visible=false/>                                
                                <asp:HyperLinkField HeaderText="修改" DataNavigateUrlFields="ProductId" DataNavigateUrlFormatString="modify.aspx?id={0}"
                                    Text="修改"  />
